...
/**
 * @enum AK8963_BIT_CNTL1_MODE
 * AK8963 Operation mode.
 */
typedef enum {
    AK8963_BIT_CNTL1_MODE_PWDN = 0x00,      /*!< Power down mode */
    AK8963_BIT_CNTL1_MODE_SNGL = 0x01,      /*!< Single measurement mode */
    AK8963_BIT_CNTL1_MODE_CNT1 = 0x02,      /*!< Continuous measurement mode 1 (8Hz) */
    AK8963_BIT_CNTL1_MODE_CNT2 = 0x06,      /*!< Continuous measurement mode 2 (100Hz) */
    AK8963_BIT_CNTL1_MODE_TEST = 0x08,      /*!< Self test mode */
}   AK8963_BIT_CNTL1_MODE;
...
/**
 * @enum MPU9250_BIT_INT
 * MPU9250 Interrupt flags.
 */
typedef enum {
    MPU9250_BIT_INT_DISABLE  = 0x00,        /*!< Disable */
    MPU9250_BIT_INT_RAW_RDY  = 0x01,        /*!< Raw sensor data ready */
    MPU9250_BIT_INT_FSYNC    = 0x08,        /*!< Fsync */
    MPU9250_BIT_INT_OVERFLOW = 0x10,        /*!< FIFO overflow */
    MPU9250_BIT_INT_WOM      = 0x40,        /*!< wake on motion */
}   MPU9250_BIT_INT;
...
/**
 * @brief      Enable MPU9250 event.
 * @param[in]  func    Pointer of event handler function.
 * @param[in]  intr_io GPIO of interrupt.
 * @param[in]  event   MPU9250 event flags.
 * @return     Initialize result
 * @retval     true    Success.
 * @retval     false   Failed.
 */
...
/**
 * @brief       Start accelerometer maesurement.
...
/**
 * @brief       Stop accelerometer maesurement.
 * @return      Result
 * @retval      true    Success.
 * @retval      false   Failed.
 * @since       2016/03/30
...
/**
 * @brief       Start magnetometer maesurement.
 * @param[in]   mode    Manetometer maesureing mode.
 * @return      Result
 * @retval      true    Success.
 * @retval      false   Failed.
 * @since       2016/03/30
...
/**
 * @brief       Stop magnetometer maesurement.
 * @return      Result
 * @retval      true    Success.
 * @retval      false   Failed.
 * @since       2016/03/30
...
/**
 * @brief   Start low power wake on motion.
 * @return      Result
 * @retval      true    Success.
 * @retval      false   Failed.
 * @since       2016/03/30
